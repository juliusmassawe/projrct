                        ...
                        @if(!$lecturer->evaluations->where('course_id', $course->id)->first())
                            ...
                            <div class="collapse multi-collapse" id="course-evaluation">
                                <div class="card card-body my-4">
                                    ...
                                    <form action="{{route('lecturer.evaluations.store')}}" method="POST" class="ml-md-2" id="evaluation-form">
                                        @csrf
                                        ...
                                        <table id="myTable" class="table app-table-hover mb-4 table-bordered text-left table-responsive-sm ">
                                            ...
                                            <tr class="@error('understanding') bg-danger @enderror">
                                                <td>5</td>
                                                <td>
                                                    <label for="understanding">Rate students' understanding level </label>
                                                </td>
                                                <td>
                                                    <div class="ml-3">
                                                        <div class="form-check form-check-inline mr-5">
                                            ...
                                            <tr class="@error('well_organized') bg-danger @enderror">
                                                <td>7</td>
                                                <td>
                                                    <label for="well_organized">Course is organized in a manner that helped students in understanding the underlying concept</label>
                                                </td>
                                                <td>
                                                    <div class="ml-3">
                                            ...
                                            <tr class="@error('meet_expectations') bg-danger @enderror">
                                                <td>9</td>
                                                <td>
                                                    <label for="meet_expectations">Does the course meet students' expectations?</label>
                                                </td>
                                                <td>
                                                    <div class="ml-3">
                                            ...
                                            <tr class="@error('helpful') bg-danger @enderror">
                                                <td>10</td>
                                                <td>
                                                    <label for="helpful">Course is helpful in progressing towards students' study</label>
                                                </td>
                                                <td>
                                                    <div class="ml-3">
