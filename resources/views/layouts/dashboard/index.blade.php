...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/images/admin.png')}}" type="image/x-icon">
    <!-- FontAwesome JS-->
                        ...
                        <div class="app-utilities col-auto">
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
                                  <img src="{{asset('assets/images/admin.png')}}" alt="" srcset=""></a>
        ...
        <div id="app-sidepanel" class="app-sidepanel">
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.html"><i class="fa fa-graduation-cap fa-2x"></i><span class="logo-text"> CES | {{auth()->user()->role->name}}</span></a>
